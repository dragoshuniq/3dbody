...
>(({ onCameraChange }, ref) => {
  ...
  const cameraPresets = {
    ...
    chest: {
      position: new Vector3(-0.392, 27.311, 21.247),
      target: new Vector3(-0.392, 24.098, -3.171),
      label: "Chest",
      icon: FaUser,
      color: "#2196F3",
    },
    legs: {
      position: new Vector3(-0.58, -11.125, 26.306),
      target: new Vector3(-0.58, -14.338, 1.888),
      label: "Legs",
      icon: FaRunning,
      color: "#9C27B0",
    },
    hands: {
      position: new Vector3(18.735, 14.324, 30.219),
      target: new Vector3(18.735, 10.171, -1.338),
      label: "Hands",
      icon: FaHands,
      color: "#FF9800",
    },
    heart: {
      position: new Vector3(3.287, 24.728, 14.094),
      target: new Vector3(3.287, 22.484, -2.958),
      label: "Heart",
      icon: FaHeart,
      color: "#f44336",
    },
    head: {
      position: new Vector3(-0.395, 69.86, 1.966),
      target: new Vector3(0.048, 42.137, -5.544),
      label: "Head",
      icon: FaBrain,
      color: "#607D8B",
    },
